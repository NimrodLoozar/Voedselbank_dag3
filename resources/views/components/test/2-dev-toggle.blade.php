...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const slider = document.querySelector('.data-toggle-slider');
    
    if (dataToggle && dataToggleSwitch && dataContainer && errorContainer && slider) {
        ...
        // Set initial state
        updateToggleState(dataToggle.checked);
        ...
        dataToggleSwitch.addEventListener('click', function() {
            dataToggle.checked = !dataToggle.checked;
            updateToggleState(dataToggle.checked);
        });
    } else {
        console.warn('Toggle elements not found. Check if all required elements exist.');
    }
});
</script>
<!-- End Developer Tools -->