...
<form class="form_container">
  <div class="logo_container">
    <svg fill="none" viewBox="0 0 24 24" height="80" width="80" xmlns="http://www.w3.org/2000/svg">
      <path stroke-width="1.5" stroke="#141B34" d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z"></path>
      <circle cx="12" cy="9" r="3" stroke-width="1.5" stroke="#141B34"></circle>
      <path stroke-width="1.5" stroke="#141B34" d="M17.9691 20C17.81 17.1085 16.9247 15 11.9999 15C7.07521 15 6.18991 17.1085 6.03076 20"></path>
    </svg>
  </div>
