...
<div class="w-full lg:w-1/3 mb-8 lg:mb-0">
    ...
    <div id="quick-actions-content" class="collapsible-content bg-white dark:bg-gray-800 shadow-xl rounded-b-lg">
        ...
        <div class="p-6 text-gray-900 dark:text-gray-100 border-t border-gray-200 dark:border-gray-700">
            <h4 class="text-lg font-semibold mb-3">Voorraad Beheer</h4>
            <a href="{{ route('inventory.overview') }}"
                class="flex items-center px-4 py-2 bg-purple-500 text-white rounded hover:bg-purple-600 mb-4 transition duration-150 shadow-xl">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
